...
We welcome all community members, contributors, and leaders to read and follow our https://github.com/IvorySQL/IvorySQL/blob/master/CODE_OF_CONDUCT.md[*Code of Conduct*]. We are committed to creating an inclusive and respectful participation environment for everyone, regardless of their background or identity characteristics. The Code of Conduct clarifies our expectations for community behavior, ensuring that all participants can collaborate in a harassment-free environment.

=== Governance

Teams are continuously open teams focused on parts of the IvorySQL project. A team has its reviewers, committers, and maintainers, and owns one or more repositories. Team-level decisions come from its maintainers. The typical progression path for IvorySQL developers is from user to reviewer, then to committer and maintainer. However, gaining more roles does not mean you have any privileges over other community members. Everyone in the IvorySQL community is equal and has the responsibility to cooperate constructively with other contributors to build a friendly community. These roles are natural rewards for your significant contributions to IvorySQL development, providing you with more rights in the development workflow to improve your efficiency. At the same time, they require you to take on some additional responsibilities:

    Team Honor: Now that you are a member of the team as a reviewer/committer/maintainer, it means you represent the project and your team members. So, please be a good person to defend the reputation of the team.

    Responsibility: Committers/maintainers have the right to merge pull requests, therefore they take on additional responsibility to deal with the consequences of accepting codebase or documentation changes. This includes rolling back or fixing it when it causes problems, as well as helping the release manager resolve any issues found during the pre-release testing cycle.
...
* https://www.ivorysql.org/assets/files/individual_cla-7703700da5e1ca8f26cb8a68f610d4f2.pdf[Individual Contributor]
* https://www.ivorysql.org/assets/files/corporate_cla-88aa01a7e770ecf89dc401f925c3438e.pdf[Corporate Contributor]
