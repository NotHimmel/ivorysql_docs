...
|*15*| xref:master/ecosystem_components/pgbouncer.adoc[pgbouncer] | 1.25.1 | Lightweight connection pooler for PostgreSQL  | High-concurrency connection management, connection reuse, reduced database connection overhead
